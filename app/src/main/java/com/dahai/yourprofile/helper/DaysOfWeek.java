...
public final class DaysOfWeek {
    ...
    public String toString(boolean showNever) {
        return toString(showNever, false);
    }

    public String toAccessibilityString() {
        return toString(false, true);
    }

    private String toString(boolean showNever, boolean forAccessibility) {
        StringBuilder ret = new StringBuilder();

        // no days
        if (mBitSet == NO_DAYS_SET) {
            return showNever ? "abc" : "";
        }
